				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							<p class="lead white-text"> {{__('lang.Libris vivendo eloquentiam ex ius, nec id splendide abhorreant, eu pro alii error homero.')}}</p>
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="#">{{__('lang.Beginner to Pro in Excel: Financial Modeling and Valuation')}}</a>
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="#">{{__('lang.The Ultimate Drawing Course | From Beginner To Advanced')}}</a>
								<div class="course-details">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-6 col-xs-6">
							<div class="course">
								...
								<a class="course-title" href="#">{{__('lang.All You Need To Know About Programming')}}</a>
								<div class="course-details">
									<span class="course-category">{{__('lang.Programming')}}</span>
								</div>
							</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-8 col-md-offset-2 text-center">
						...
						<p class="lead white-text">{{__('lang.Libris vivendo eloquentiam ex ius, nec id splendide abhorreant.')}}</p>
