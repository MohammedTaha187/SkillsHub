              ...
              <div class="blog-post mb-5">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="radio">
                            <label>
                              <input type="radio" name="question[{{ $question->id }}]" id="optionsRadios1" value="option1">
                              {{$question->option_1}}
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                              <input type="radio" name="question[{{ $question->id }}]" id="optionsRadios2" value="option2">
                              {{$question->option_2}}
                            </label>
                        </div>
                        <div class="radio">
                            <label>
                              <input type="radio" name="question[{{ $question->id }}]" id="optionsRadios3" value="option3">
                              {{$question->option_3}}
                            </label>
                        </div>
                        <div class="radio">
