            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    <ul class="hero-area-tree">
                        ...
                        <li><a href="{{ url("/categories/show/" . $exam->skill->cat->id) }}">{{ $exam->skill->name() }}</a>
                        </li>
                        <li>{{ $exam->name() }}</li>
                    </ul>
                    ...
                    <ul class="blog-post-meta">
                        ...
                        <li class="blog-meta-comments"><a href="#"><i class="fa fa-users"></i>
                                {{ $exam->skill->getStudentCount() }}</a></li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div id="main" class="col-md-9">
                    ...
                    <div>
                        ...
                        <button class="main-button icon-button btn-danger pull-left ml-sm">
                            {{ __("lang.Cancel") }}</button>
                    </div>
                </div>
                <!-- /main blog -->
