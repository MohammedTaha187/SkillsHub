            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1 text-center">
                    <ul class="hero-area-tree">
                        ...
                        <li><a
                                href="{{ url("/categories/show/" . $exams->skill->cat->id) }}">{{ $exams->skill->cat->name() }}</a>
                        </li>
                        <li><a href="{{ url("/categories/show/" . $exams->skill->cat->id) }}">{{ $exams->skill->name() }}</a>
                        </li>
                        <li>{{ $exams->name() }}</li>
                    </ul>
                    ...
                    <ul class="blog-post-meta">
                        ...
                        <li class="blog-meta-comments"><a href="#"><i class="fa fa-users"></i>
                                {{ $exams->skill->getStudentCount() }}</a></li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div id="main" class="col-md-9">
                    ...
                    <div>
                        <div>
                            <a href="{{ url("/exams/questions/" . $exams->id) }}" class="main-button icon-button pull-left">
                                {{ __("lang.start_exam") }}</a>
                        </div>
